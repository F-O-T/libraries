...
### Fixed
- `decodeDer` now handles BER indefinite-length encoding (`0x80` length byte) by scanning for end-of-content octets (`00 00`), enabling parsing of legacy PFX/PKCS#12 files generated by older tools (e.g. Lacuna Software test certificates)
