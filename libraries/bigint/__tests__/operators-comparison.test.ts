...
describe("bigintEqualsOperator", () => {
   ...
   test("validates input schema", () => {
      expect(() =>
         bigintEqualsOperator.evaluate("invalid", { value: 100n, scale: 2 }),
      ).toThrow();
   });
...
describe("bigintGreaterThanOperator", () => {
   ...
   test("handles negative values", () => {
      ...
      expect(bigintGreaterThanOperator.evaluate(actual2, expected2)).toBe(
         false,
      );
   });
   ...
   test("handles mixed signs", () => {
      ...
      expect(bigintGreaterThanOperator.evaluate(negative, positive)).toBe(
         false,
      );
   });
});
...
describe("bigintGreaterThanOrEqualOperator", () => {
   test("returns true when actual >= expected", () => {
      ...
      expect(
         bigintGreaterThanOrEqualOperator.evaluate(actual1, expected1),
      ).toBe(true);

      const actual2 = { value: 100n, scale: 2 };
      const expected2 = { value: 100n, scale: 2 };
      expect(
         bigintGreaterThanOrEqualOperator.evaluate(actual2, expected2),
      ).toBe(true);
   });
   ...
   test("returns false when actual < expected", () => {
      const actual = { value: 50n, scale: 2 };
      const expected = { value: 100n, scale: 2 };
      expect(bigintGreaterThanOrEqualOperator.evaluate(actual, expected)).toBe(
         false,
      );
   });
});
...
describe("bigintLessThanOrEqualOperator", () => {
   test("returns true when actual <= expected", () => {
      ...
      expect(bigintLessThanOrEqualOperator.evaluate(actual1, expected1)).toBe(
         true,
      );

      const actual2 = { value: 100n, scale: 2 };
      const expected2 = { value: 100n, scale: 2 };
      expect(bigintLessThanOrEqualOperator.evaluate(actual2, expected2)).toBe(
         true,
      );
   });
   ...
   test("returns false when actual > expected", () => {
      const actual = { value: 100n, scale: 2 };
      const expected = { value: 50n, scale: 2 };
      expect(bigintLessThanOrEqualOperator.evaluate(actual, expected)).toBe(
         false,
      );
   });
});
